...
import { useCheckUserExists } from '@/hooks/users/useCheckUserExists';
export const PasswordSetting = () => {
  ...
  const {data:isUse,refetch,isLoading} = useCheckUserExists(
    accountField.state.value
  )
      ...
      <form.Field
        ...
        validators={{
          onBlurAsync: async ({ value }) => {
            ...
            if (value !== accountField.state.value) {
              await refetch();
            }
      ...
      <form.Field
        ...
        children={field => (
          <div className="relative mt-1">
            ...
            <div className="relative mt-1">
              <Key className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 transform text-slate-400" />
              <PasswordInput
                id="password"
      ...
      <form.Field
        ...
        children={field => (
          <div className="relative mt-1">
            ...
            <div className="relative mt-1">
              <CheckCheck className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 transform text-slate-400" />
              <PasswordInput
                id="confirmPassword"
